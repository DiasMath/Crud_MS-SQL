...
namespace Crud_MS_SQL.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Telefone,Endereco,Agendamento,Servico")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Telefone,Endereco,Agendamento,Servico")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
